...
export function Header({handle_logout, userData}) {
            ...
            <AppBar
                ...
                <Toolbar className={classes.toolbar}>
                    ...
                    <Typography
                        ...
                        <Link className={classes.titleLink} to="/">Instagram Tracker</Link>
                    </Typography>
                    ...
                    {userData.loggedIn && <Button onClick={handle_logout} variant="contained" color="error">
                        Log Out
                    </Button>}
                </Toolbar>
            </AppBar>
